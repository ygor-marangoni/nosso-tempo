...
function refreshHome() {
  ...
  if (c.startDate) {
    ...
    document.getElementById('lbl-years').textContent  = years  === 1 ? 'ano'  : 'anos';
    document.getElementById('lbl-months').textContent = months === 1 ? 'mês'  : 'meses';
    document.getElementById('lbl-days').textContent   = days   === 1 ? 'dia'  : 'dias';
